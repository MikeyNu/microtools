...
export default function ColorPickerPage() {
  ...
  return (
    <ToolLayout
      title="Color Picker"
      description="Pick and convert colors in HEX, RGB, HSL, and CMYK"
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="grid grid-cols-3 gap-2 mt-2">
                        <div>
                          <Label htmlFor="r-slider" className="text-sm text-destructive">R: {colorFormats.rgb.r}</Label>
                          <Slider
                            id="r-slider"
                            min={0}
                            max={255}
                        ...
                        <div>
                          <Label htmlFor="g-slider" className="text-sm text-success">G: {colorFormats.rgb.g}</Label>
                          <Slider
                            id="g-slider"
                            min={0}
                            max={255}
                        ...
                        <div>
                          <Label htmlFor="b-slider" className="text-sm text-muted-foreground">B: {colorFormats.rgb.b}</Label>
                          <Slider
                            id="b-slider"
                            min={0}
                            max={255}
