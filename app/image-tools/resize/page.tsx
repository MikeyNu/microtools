          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <label className="text-sm font-medium text-muted-foreground">Maintain Aspect Ratio</label>
                  <p className="text-xs text-muted-foreground">Keep original proportions when resizing</p>
                </div>
                <Switch
        ...
        <Card className="mb-8">
          <CardContent className="pt-6">
            <div className="text-center mb-4">
              <h3 className="font-medium text-foreground mb-2">Resizing Images...</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-medium text-foreground">Maintain Aspect Ratio</h4>
                  <p className="text-sm text-muted-foreground">Keep this on to prevent image distortion</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-medium text-foreground">Use Presets</h4>
                  <p className="text-sm text-muted-foreground">Quick sizing for social media platforms</p>
                </div>
              </div>
            </div>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-medium text-foreground">Quality Preservation</h4>
                  <p className="text-sm text-muted-foreground">Avoid upscaling for best quality</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
