              ...
              <TabsContent value="input">
                <Card>
                  ...
                  <CardContent>
                    <div
                      className={`relative ${
                        dragActive ? 'border-2 border-dashed border-border bg-muted/50' : ''
                      }`}
                      onDrop={handleDrop}
                    ...
                    >
                      ...
                      />
                      {dragActive && (
                        <div className="absolute inset-0 flex items-center justify-center bg-muted/50/90 border-2 border-dashed border-border rounded">
                          <div className="text-center">
                            <Upload className="h-8 w-8 mx-auto mb-2 text-muted-foreground" />
                            <p className="text-muted-foreground font-medium">Drop CSV file here</p>
                          </div>
                        </div>
                      )}
                    </div>
