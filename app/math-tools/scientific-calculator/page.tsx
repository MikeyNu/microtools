            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-8 gap-2">
                  ...
                  <Button variant="outline" onClick={() => handleButtonClick('M-')} className="text-xs">M-</Button>
                  <Button variant="outline" onClick={() => handleButtonClick('C')} className="text-destructive">C</Button>
                  <Button variant="outline" onClick={() => handleButtonClick('CE')} className="text-destructive">CE</Button>
                  <Button variant="outline" onClick={() => handleButtonClick('←')}><Delete className="h-4 w-4" /></Button>
                  <Button variant="outline" onClick={() => handleButtonClick('/')} className="text-muted-foreground">÷</Button>
                  ...
                  <Button variant="default" onClick={() => handleButtonClick('=')} className="bg-accent hover:bg-accent/90">=</Button>
                </div>
              </CardContent>
            </Card>
          </div>
