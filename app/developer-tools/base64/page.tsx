        ...
        {(error || isValidBase64 !== null) && (
          <div className="mb-6">
            {error ? (
              ...
              <Alert className={isValidBase64 ? "border-success/20 bg-success/10" : "border-destructive/20 bg-destructive/10"}>
                {isValidBase64 ? (
                  <CheckCircle className="h-4 w-4 text-success" />
                ) : (
                  <AlertCircle className="h-4 w-4 text-destructive" />
                )}
                <AlertDescription className={isValidBase64 ? "text-success" : "text-destructive"}>
            ...
            <CardContent>
              <div className="space-y-4">
                <Textarea
                  value={outputText}
                  readOnly
                  className={`min-h-[300px] ${mode === 'encode' ? 'font-mono' : ''} text-sm bg-muted/50`}
