      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-3">
            <div>
              ...
              <div className="flex items-center space-x-2">
                <div className="font-mono text-lg bg-muted/50 p-2 rounded flex-1">
                  {result.seconds}
                </div>
            ...
            <div>
              <Label className="text-sm font-medium text-muted-foreground">Microseconds</Label>
              <div className="flex items-center space-x-2">
                <div className="font-mono text-sm bg-muted/50 p-2 rounded flex-1">
                  {result.microseconds}
                </div>
            ...
            <div>
              <Label className="text-sm font-medium text-muted-foreground">Nanoseconds</Label>
              <div className="flex items-center space-x-2">
                <div className="font-mono text-sm bg-muted/50 p-2 rounded flex-1">
                  {result.nanoseconds}
                </div>
          ...
          <div className="space-y-3">
            ...
            <div>
              <Label className="text-sm font-medium text-muted-foreground">RFC 2822</Label>
              <div className="flex items-center space-x-2">
                <div className="font-mono text-sm bg-muted/50 p-2 rounded flex-1">
                  {result.rfc2822}
                </div>
            ...
            <div>
              <Label className="text-sm font-medium text-muted-foreground">Human Readable</Label>
              <div className="flex items-center space-x-2">
                <div className="text-sm bg-muted/50 p-2 rounded flex-1">
            ...
            <div>
              ...
              <div className="flex items-center space-x-2">
                <div className="text-sm bg-muted/50 p-2 rounded flex-1 text-foreground">
                  {result.relative}
                </div>
    ...
    >
      ...
      <Card className="mt-8">
        ...
        <CardContent className="grid md:grid-cols-2 gap-6 text-sm text-muted-foreground">
          <div>
            <h4 className="font-medium text-foreground mb-2">Precision Levels</h4>
          ...
          <div>
            <h4 className="font-medium text-foreground mb-2">Format Standards</h4>
            <ul className="space-y-1">
