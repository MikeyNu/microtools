    ...
    >
            ...
            <CardContent className="space-y-4">
              ...
              {convertedTime && (
                <div className="p-4 bg-muted/50 rounded-lg">
                  <Label className="text-sm font-medium text-foreground">Converted Time:</Label>
      ...
      <Card className="mt-8">
        ...
        <CardContent className="grid md:grid-cols-2 gap-6 text-sm text-muted-foreground">
          <div>
            <h4 className="font-medium text-foreground mb-2">Daylight Saving Time</h4>
            <p>
          ...
          <div>
            <h4 className="font-medium text-foreground mb-2">UTC Offset</h4>
            <p>
          ...
          <div>
            <h4 className="font-medium text-foreground mb-2">World Clock</h4>
            <p>
          ...
          <div>
            <h4 className="font-medium text-foreground mb-2">Accuracy</h4>
            <p>
