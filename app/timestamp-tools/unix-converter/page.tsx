    ...
    >
      ...
      <Card className="mt-8">
        ...
        <CardContent className="space-y-4 text-sm text-muted-foreground">
          <div>
            <h4 className="font-medium text-foreground mb-1">What is a Unix Timestamp?</h4>
            <p>
          ...
          <div>
            <h4 className="font-medium text-foreground mb-1">Seconds vs Milliseconds</h4>
            <p>
          ...
          <div>
            <h4 className="font-medium text-foreground mb-1">Timezone Support</h4>
            <p>
