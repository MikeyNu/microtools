...
console.log('Total with tax:', calculateTotal(items, taxRate));`;
  ...
  const getLineStyle = (type: string) => {
    switch (type) {
      case 'added':
        return 'bg-success/10 border-l-4 border-success/40 text-success';
      case 'removed':
        return 'bg-destructive/10 border-l-4 border-destructive/40 text-destructive';
      case 'modified':
        return 'bg-warning/10 border-l-4 border-warning/40 text-warning';
      default:
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-warning">{stats.modifications}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="flex items-center gap-2">
                <div className="w-4 h-4 bg-success/10 border-l-4 border-success/40 rounded-sm"></div>
                <span className="text-sm">Added lines</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-4 h-4 bg-destructive/15 border-l-4 border-destructive/40 rounded-sm"></div>
