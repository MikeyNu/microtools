...
export default function SSLCheckerPage() {
  ...
  const getGradeColor = (grade: string) => {
    switch (grade) {
      case 'A+': case 'A': return 'text-success bg-success/10'
      case 'B': return 'text-muted-foreground bg-muted/50'
          ...
          <Card>
            <CardContent className="py-8">
              <div className="text-center space-y-4">
                <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-accent/40 mx-auto"></div>
