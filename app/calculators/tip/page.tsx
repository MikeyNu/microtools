...
import { Receipt, Calculator, Users, DollarSign, Percent, Info, AlertCircle } from "lucide-react"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <Card>
                          <CardContent className="p-6 text-center">
                            ...
                            <div className="text-2xl font-bold text-success">${results.tipAmount}</div>
                        ...
                        <Card>
                          <CardContent className="p-6 text-center">
                            ...
                            <div className="text-2xl font-bold text-muted-foreground">${results.perPerson}</div>
                        ...
                        <CardContent>
                          <div className="space-y-4">
                            ...
                            <div className="flex justify-between items-center">
                              ...
                              <span className="font-semibold text-success">${results.tipAmount}</span>
                            </div>
